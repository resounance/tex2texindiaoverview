...
import { Cpu, Factory, Megaphone, Building2 } from "lucide-react";
...
export default function KeyActivities() {
  return (
    <DeckSection id="activities">
      <div className="text-center mb-6">
        <p className="text-sm font-mono text-muted-foreground tracking-widest uppercase mb-3">Operations</p>
        <h2 className="text-3xl md:text-4xl font-bold text-foreground">Key Activities</h2>
      </div>
